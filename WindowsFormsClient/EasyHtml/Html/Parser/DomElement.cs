...
namespace Nx.EasyHtml.Html.Parser
{
  ...
  public class DomElement : DomNode, IHtmlElement, IDomContainer
  {
    ...
    private static readonly Regex tagNameRegex = Regulars.Instance.TagName;
    private static readonly Regex attributeNameRegex = Regulars.Instance.AttributeName;
