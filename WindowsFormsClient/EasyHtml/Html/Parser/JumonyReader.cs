...
using System.Linq;
using System.Text;
using Nx.EasyHtml.Html.Parser.ContentModels;
...
namespace Nx.EasyHtml.Html.Parser
{
    ...
    public class JumonyReader : IHtmlReader
    {
        ...
        /// </summary>
        protected static readonly Regex tagRegex = Regulars.Instance.HtmlTag;


        /// <summary>
        /// 用于匹配属性设置的正则表达式对象
        /// </summary>
        protected static readonly Regex attributeRegex = Regulars.Instance.Attribute;

        /// <summary>
        /// 用于匹配元素标签名的正则
        /// </summary>
        public static readonly Regex tagNameRegex = Regulars.Instance.TagName;
